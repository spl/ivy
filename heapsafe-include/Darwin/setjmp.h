...
#define __hs_trace
#else
#define __hs_trace __attribute__((hs_trace))
#endif
 ...
 * onstack, mask = 2 ints
 * direct_vars, indirect_vars, scope_count = 3 ints
 */
...
extern void longjmp(jmp_buf env, int val) __hs_trace;

#ifndef _ANSI_SOURCE
int	_setjmp(jmp_buf env);
void	_longjmp(jmp_buf, int val) __hs_trace;
int sigsetjmp(sigjmp_buf env, int val);
void siglongjmp(sigjmp_buf env, int val) __hs_trace;
#endif /* _ANSI_SOURCE  */
