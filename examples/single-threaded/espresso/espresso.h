...
#define free_cubelist(T)        {pcube _T = T[0]; FREE(T); FREE(_T);}
...
/* cofactor.c */	extern pcover cubeunlist(pset *A1);
/* cofactor.c */	extern pcube *cofactor(pset *T, register pset c);
/* cofactor.c */	extern pcube *cube1list(pset_family A);
/* cofactor.c */	extern pcube *cube2list(pset_family A, pset_family B);
/* cofactor.c */	extern pcube *cube3list(pset_family A, pset_family B, pset_family C);
/* cofactor.c */	extern pcube *scofactor(pset *T, pset c, int var);
/* cofactor.c */	extern void massive_count(pset *T);
/* compl.c */	extern pcover complement(pset *T);
/* compl.c */	extern pcover simplify(pset *T);
/* compl.c */	extern void simp_comp(pset *T, pset_family *Tnew, pset_family *Tbar);
/* contain.c */	extern int d1_rm_equal(register pset *A1, int (*compare) (/* ??? */));
/* contain.c */	extern int rm2_contain(pset *A1, pset *B1);
/* contain.c */	extern int rm2_equal(register pset *A1, register pset *B1, pset *E1, int (*compare) (/* ??? */));
/* contain.c */	extern int rm_contain(pset *A1);
/* contain.c */	extern int rm_equal(pset *A1, int (*compare) (/* ??? */));
/* contain.c */	extern int rm_rev_contain(pset *A1);
/* contain.c */	extern pset *sf_list(register pset_family A);
/* contain.c */	extern pset *sf_sort(pset_family A, int (*compare) (/* ??? */));
...
/* cvrm.c */	extern pcover cof_output(pset_family T, register int i);
/* cvrm.c */	extern pcover lex_sort(pset_family T);
/* cvrm.c */	extern pcover mini_sort(pset_family F, int (*compare) (/* ??? */));
/* cvrm.c */	extern pcover random_order(register pset_family F);
/* cvrm.c */	extern pcover size_sort(pset_family T);
/* cvrm.c */	extern pcover sort_reduce(pset_family T);
/* cvrm.c */	extern pcover uncof_output(pset_family T, int i);
/* cvrm.c */	extern pcover unravel(pset_family B, int start);
/* cvrm.c */	extern pcover unravel_range(pset_family B, int start, int end);
...
/* cvrmisc.c */	extern void print_trace(pset_family T, char *name, long int time);
/* cvrmisc.c */	extern void size_stamp(pset_family T, char *name);
/* cvrmisc.c */	extern void totals(long int time, int i, pset_family T, pcost cost);
...
/* espresso.c */	extern pcover espresso(pset_family F, pset_family D1, pset_family R);
/* essen.c */	extern bool essen_cube(pset_family F, pset_family D, pset c);
/* essen.c */	extern pcover cb_consensus(register pset_family T, register pset c);
/* essen.c */	extern pcover cb_consensus_dist0(pset_family R, register pset p, register pset c);
/* essen.c */	extern pcover essential(pset_family *Fp, pset_family *Dp);
/* exact.c */	extern pcover minimize_exact(pset_family F, pset_family D, pset_family R, int exact_cover);
/* exact.c */	extern pcover minimize_exact_literals(pset_family F, pset_family D, pset_family R, int exact_cover);
/* expand.c */	extern bool feasibly_covered(pset_family BB, pset c, pset RAISE, pset new_lower);
/* expand.c */	extern int most_frequent(pset_family CC, pset FREESET);
/* expand.c */	extern pcover all_primes(pset_family F, pset_family R);
/* expand.c */	extern pcover expand(pset_family F, pset_family R, int nonsparse);
/* expand.c */	extern pcover find_all_primes(pset_family BB, register pset RAISE, register pset FREESET);
...
/* gasp.c */	extern pcover expand_gasp(pset_family F, pset_family D, pset_family R, pset_family Foriginal);
/* gasp.c */	extern pcover irred_gasp(pset_family F, pset_family D, pset_family G);
/* gasp.c */	extern pcover last_gasp(pset_family F, pset_family D, pset_family R, cost_t *cost);
/* gasp.c */	extern pcover super_gasp(pset_family F, pset_family D, pset_family R, cost_t *cost);
...
/* getopt.c */	extern int getopt(int argc, char *const *argv, const char *optstring);
...
/* hack.c */	extern pcover map_symbolic_cover(pset_family T, symbolic_list_t *list, int base);
/* hack.c */	extern void symbolic_hack_labels(pPLA PLA, symbolic_t *list, pset compress, int new_size, int old_size, int size_added);
/* irred.c */	extern bool cube_is_covered(pset *T, pset c);
/* irred.c */	extern bool tautology(pset *T);
/* irred.c */	extern pcover irredundant(pset_family F, pset_family D);
...
/* opo.c */	extern pcover opo(pset phase, pset_family T, pset_family D, pset_family R, int first_output);
/* opo.c */	extern pcube find_phase(pPLA PLA, int first_output, pset phase1);
...
/* pair.c */	extern int find_best_cost(register ppair pair);
/* pair.c */	extern int greedy_best_cost(int **cost_array_local, ppair *pair_p);
/* pair.c */	extern int minimize_pair(ppair pair);
/* pair.c */	extern void pair_free(register ppair pair);
/* pair.c */	extern void pair_all(pPLA PLA, int pair_strategy);
/* pair.c */	extern pcover delvar(pset_family A, int *paired);
/* pair.c */	extern pcover pairvar(pset_family A, ppair pair);
...
/* primes.c */	extern pcover primes_consensus(pset *T);
/* reduce.c */	extern bool sccc_special_cases(pset *T, pset *result);
/* reduce.c */	extern pcover reduce(pset_family F, pset_family D);
/* reduce.c */	extern pcube reduce_cube(pset *FD, pset p);
/* reduce.c */	extern pcube sccc(pset *T);
/* reduce.c */	extern pcube sccc_cube(register pset result, register pset p);
/* reduce.c */	extern pcube sccc_merge(register pset left, register pset right, register pset cl, register pset cr);
/* set.c */	extern bool set_andp(register pset r, register pset a, register pset b) hs_nofree;
/* set.c */	extern bool set_orp(register pset r, register pset a, register pset b) hs_nofree;
/* set.c */	extern bool setp_disjoint(register pset a, register pset b) hs_nofree;
/* set.c */	extern bool setp_empty(register pset a) hs_nofree;
/* set.c */	extern bool setp_equal(register pset a, register pset b) hs_nofree;
/* set.c */	extern bool setp_full(register pset a, register int size) hs_nofree;
/* set.c */	extern bool setp_implies(register pset a, register pset b) hs_nofree;
...
/* set.c */	extern int set_dist(register pset a, register pset b) hs_nofree;
/* set.c */	extern int set_ord(register pset a) hs_nofree;
/* set.c */	extern void set_adjcnt(register pset a, register int *count, register int weight);
/* set.c */	extern pset set_and(register pset r, register pset a, register pset b) hs_nofree;
/* set.c */	extern pset set_clear(register pset r, int size) hs_nofree;
/* set.c */	extern pset set_copy(register pset r, register pset a) hs_nofree;
/* set.c */	extern pset set_diff(register pset r, register pset a, register pset b) hs_nofree;
/* set.c */	extern pset set_fill(register pset r, register int size) hs_nofree;
/* set.c */	extern pset set_merge(register pset r, register pset a, register pset b, register pset mask) hs_nofree;
/* set.c */	extern pset set_or(register pset r, register pset a, register pset b) hs_nofree;
/* set.c */	extern pset set_xor(register pset r, register pset a, register pset b) hs_nofree;
...
/* setc.c */	extern bool ccommon(register pset a, register pset b, register pset cof);
/* setc.c */	extern bool cdist0(register pset a, register pset b);
/* setc.c */	extern bool full_row(register pset p, register pset cof) hs_nofree;
...
/* sharp.c */	extern pcover cb1_dsharp(pset_family T, pset c);
/* sharp.c */	extern pcover cb_dsharp(pset c, pset_family T);
/* sharp.c */	extern pcover cb_recur_dsharp();
/* sharp.c */	extern pcover cb_recur_sharp(pset c, pset_family T, int first, int last, int level);
/* sharp.c */	extern pcover cb_sharp(pset c, pset_family T);
/* sharp.c */	extern pcover cv_dsharp(pset_family A, pset_family B);
/* sharp.c */	extern pcover cv_intersect(pset_family A, pset_family B);
/* sharp.c */	extern pcover cv_sharp(pset_family A, pset_family B);
/* sharp.c */	extern pcover dsharp(pset a, pset b);
/* sharp.c */	extern pcover make_disjoint(pset_family A);
/* sharp.c */	extern pcover sharp(pset a, pset b);
/* sminterf.c */pset do_sm_minimum_cover(pset_family A);
/* sparse.c */	extern pcover make_sparse(pset_family F, pset_family D, pset_family R);
/* sparse.c */	extern pcover mv_reduce(pset_family F, pset_family D);
/* ucbqsort.c 	extern qsort(); */
/* ucbqsort.c */	extern qst();
/* unate.c */	extern pcover find_all_minimal_covers_petrick();
/* unate.c */	extern pcover map_cover_to_unate(pset *T);
...
/* verify.c */	extern bool verify(pset_family F, pset_family Fold, pset_family Dold);
