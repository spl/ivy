 ...
 */
extern precision 	palloc(posit) hs_nofree;/* semi-private */
extern int 		pfree(precision);	/* semi-private */
extern void 		pnorm(precision);	/* semi-private */
